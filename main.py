...
def main():
    try:
        if os.geteuid() != 0:
            try:
                Write.Print(f"( ! ) You need to have root privileges to run this script.\nPlease try again, this time using 'sudo su' before :3\n", Colors.red_to_purple, interval=0.0200)
                exit() # pass for windows users
